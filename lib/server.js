...
const index = require('./generated')
const { parseConfigFile, resolve } = require('./utils')

module.exports = function () {
  const root_config = parseConfigFile('/config.yml')
  const public = resolve('/' + root_config.public)
  ...
  logger.info('Service started, please visit: http://127.0.0.1:' + port)
}
